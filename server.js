...
client.on("ready", () => {
  ...
  client.user.setActivity(`Protect arabic security`, { type: "STREAMING" });
});
...
\`انا درع ساهر يحمي السيرفر متحاولش تغدر في تلاته كمان زيي`);
        })
        .then(e => {
          message.react("✅");
        })
...
\`${prefix}repeat\` : تكرار الاغنية 
\`
Helloooo im بوت حمايه هكون ايه يعني
`);
        })
        .then(e => {
          message.react("✅");
